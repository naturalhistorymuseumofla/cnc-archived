...
<div class="td-container">
  <div class="row" style="margin-top:50px; margin-bottom:30px;">
    <h2 class="weight-400" style="padding-left:25px;">2019 City List</h2>
  </div>
</div> 


	<div class="td-main-content-wrap td-container-wrap">
		<div class="td-page-header td-container" style="display:none;">
			<div class="td-crumb-container">
		            <?php //echo td_page_generator::get_page_breadcrumbs(get_the_title()); ?>
	        </div>
			<h1 class="entry-title td-page-title" style="padding-left:25px;">City List</h1>
			<div class="tdm-title-line"></div>
		</div>
		<div id="city_table" class="container table-responsive table-hover mt-4"style="max-width:1015px; margin:0 auto;">
			<!-- <table class="table">
				<tr>
					<thead>
						<th>City</th>
	...
	<script type="text/javascript">
		...
		window.onload = function(){
			$.ajax({
				url: "../wp-content/uploads/2018/11/2019clistNov2.csv", //this file is a utf-8 encoded file
				dataType: "text",
