<?php
/*  ----------------------------------------------------------------------------
    Template Name: 2018-leaderboard
 */
...
<div class="td-main-content-wrap td-container-wrap">
	<div class="td-page-header td-container">
		...
		<h1 class="entry-title td-page-title">2018 Leaderboard</h1>
		<div class="tdm-title-line"></div>
		
	</div>

	<div class="tdc-row aligncenter">	
			<h2 class="tdm-title">Leaderboard</h2>	
	</div>
	...
	<div class="container dsk-view">
		...
		<!-- 	<div class="col-3 det-box">
				<div id='first' class="container-fluid leader-thumbnails  text-center p-0">
			...
			<div class="col-3 det-box">
				<div id='second' class="container leader-thumbnails text-center p-0">
				
				
					
					<div class="details container-fluid float-right  p-0">
						<h2 class="stat mb-1"></h2>
						<p class='title mx-auto'>
			...
			<div class="col-3 det-box">
				<div id='third' class="container leader-thumbnails  text-center p-0">
	...
	<!-- <div class="holder row ">
		<div class="float-left img-cont">
			<img class="img-thumbnail float-left stat-icon border-0">
		</div>
		<div class=" det-cont">
			
			<div id='first' class="container leader-thumbnails  text-center p-0">
			...
			<div id='second' class="container leader-thumbnails text-center p-0">
				...
				<img class="stat-icon img-thumbnail float-left w-50 ">
				<div class="details container-fluid float-right  p-0">
					<h2 class="stat mb-1"></h2>
					<p class='title mx-auto'>
...
<script>
	var stat_icons = [
		"../wp-content/uploads/2017/12/observations-icon-150x150.png",
		"../wp-content/uploads/2017/12/species-icon-150x150.png",
		"../wp-content/uploads/2017/12/people-icon-150x150.png"
	];
...
//	console.log(sort_btns);
	...
	//MOBILE SELECT CHANGE FUNCTIONALITY
	...
	$('.peopleHeader').click( function(){
		...
		function finalResults(){
			$.ajax({
				url: "../wp-content/uploads/2018/03/cnc_final_results_5_16_18.csv", //this file is a utf-8 encoded file
				dataType: "text",
		...
		//	console.log('HERE');
			$.ajax({
				url: "../wp-content/uploads/2018/03/non-iNat3.csv", //this file is a utf-8 encoded file
				dataType: "text",
				success:function(data){
					//console.log(data);
					var city_data = data.split("//");
