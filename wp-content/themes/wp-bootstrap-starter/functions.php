...
function wpexplorer_add_dashboard_widgets() {
	wp_add_dashboard_widget(
		...
		'City Nature Challenge API', // Title.
...
function wpexplorer_dashboard_widget_function() {
    echo '<a href="http://138.68.1.184/" target="_blank">API</a>';
    echo '<br/>';
    echo '<a href="http://138.68.1.184/admin" target="_blank">API Admin</a>';
    echo '<br/>';
    echo '<a href="http://138.68.1.184/accounts/login/" target="_blank">API User</a>';
}
...
function wp_bootstrap_starter_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wp_bootstrap_starter_content_width', 1360 );
}
...
function wp_bootstrap_starter_scripts() {
	// load bootstrap css
	wp_enqueue_style( 'wp-bootstrap-starter-bootstrap-css', get_template_directory_uri() . '/inc/assets/css/bootstrap.css' ); /* Modified: /inc/assets/css/bootstrap.min.css */
    // fontawesome cdn
...
*/
    ...
    if( is_front_page() ){
        wp_enqueue_style( 'style-nav', get_template_directory_uri() . '/transparent-navbar.css' );
    } 
    ...
    /* Custom JS - City Nature Challenge */
    wp_enqueue_script( 'script', get_template_directory_uri() . '/custom.js' );

    /* Moment JS */
    wp_enqueue_script( 'script-moment', get_template_directory_uri() . '/moment-with-locales.js' );
    /* Moment JS */
    wp_enqueue_script( 'script-timezone', get_template_directory_uri() . '/moment-timezone-with-data.js' );
...
function filter_revisions_to_keep_as_backup( $num, $post ) {
    return $num;
}

add_filter( 'wp_revisions_to_keep', 'filter_revisions_to_keep_as_backup', 15, 2 );

/* Custom */
/* This makes WP not add <br> or <p> tags */
