<?php
/* 
 *   Template Name: Leaderboard-2019
 */
get_header();
?>
<!-- jQuery -->
...
function processObs(arr){
	...
	// IF IT'S FROM THE API, UNCOMMENT BELOW - Start Santiago's Ajax ... adds 5 cities
...
var processPeopleMobile = function(arr){
	console.log("processPeopleMobile");
