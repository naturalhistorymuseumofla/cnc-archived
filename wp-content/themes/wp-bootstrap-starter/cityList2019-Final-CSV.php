<?php
/*  ----------------------------------------------------------------------------
    Template Name: City-List-2019-Final-CSV
 */
...
<div class="container">
  <div class="row" style="margin-top:100px; margin-bottom:30px;">
    <h2 class="weight-400" style="padding-left:30px;">2019 City List</h2>
  </div>
</div> 
	...
	<script type="text/javascript">
		...
		window.onload = function(){
			$.ajax({
				url: "../wp-content/uploads/2019/09/2019-City-List-Fixed-Format-Removed-Commas.csv", //this file is a utf-8 encoded file
				dataType: "text",
