...
<div class="container">
  <div class="row" style="margin-top:100px; margin-bottom:30px;">
    <h2 class="weight-400" style="padding-left:30px;">2018 City List</h2>
  </div>
</div> 
	...
	<script type="text/javascript">
		...
		window.onload = function(){
			$.ajax({
				url: "../wp-content/uploads/2018/08/city_names_final_v7.csv", //this file is a utf-8 encoded file
				dataType: "text",
