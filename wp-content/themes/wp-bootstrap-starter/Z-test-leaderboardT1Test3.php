<?php
/* 
 *   Template Name: T-Leaderboard-Test3
 */
...
<style type="text/css">
	...
	.td-main-content-wrap-image {
		background-image: url('/wp-content/uploads/2018/09/CNC_Favicon-tall.jpg');
	...
	/* Slide 1 */
	.mobile-slide-1 > tr > td:nth-child(3),
	.mobile-slide-1 > tr > td:nth-child(4) {
		display:none;
	}
	/* Slide 2 */
	.mobile-slide-2 > tr > td:nth-child(2),
	.mobile-slide-2 > tr > td:nth-child(4) {
		display:none;
	}
	/* Slide 3 */
	.mobile-slide-3 > tr > td:nth-child(2),
	.mobile-slide-3 > tr > td:nth-child(3) {
		display:none;
	}
</style>
...
<!-- ============ MOBILE ============ -->
<div class="td-main-content-wrap td-main-content-wrap-image mb-view" style="min-height:50px;">
	<div class="container" style="padding-top:15px;">
		...
		<!-- LINE -->
		<div style="width:150px; height:2px; border-bottom: 1px solid #fff; margin:0 auto; display:block; margin-top:-10px;"></div>


		<!-- NAVIGATION -->
		<div class="text-center" style="width:100%; margin-top:40px; overflow:visible; margin-bottom:5px;">
			<!-- People -->
		...
		<div class="col-md-12 col-sm-12">
			...
			<div class="mobile-leaderboard-results"><!-- SLICK CONTAINER -->
				<!-- ***** OBSERVATIONS ***** -->
			  	<div style="width:80%;"><!-- SLICK SLIDE 1 -->
						...
						<!-- ROW 2 - SLIDE 1 -->
						<div style="margin-top:50px; width:100%; height:440px;">
							<!-- Column Left -->
						...
						<!-- ============ LIST ============ -->
						<div>
							<h3 class="display-5 weight-700 text-center">Observations</h3>
							<div style="width:50%; height:2px; background-color: #222; margin:0 auto; display:block; margin-top:-10px; margin-bottom:30px;"></div>
							<table class="table the-table">
								<thead style="border-left: none; border-right: none; display:none;">
									<tr>
								...
								<tbody class="mobile-slide-1"></tbody>
							</table>
						</div>
			  	</div>
			  	<!-- ***** SPECIES ***** -->
			  	<div style="width:80%;"><!-- SLICK SLIDE 2 -->
			  		...
			  		<!-- ROW 1 - SLIDE 2 -->
						...
						<!-- ============ LIST ============ -->
						<div>
							<h3 class="display-5 weight-700 text-center">Species</h3>
							<div style="width:50%; height:2px; background-color: #222; margin:0 auto; display:block; margin-top:-10px; margin-bottom:30px;"></div>
							<table class="table the-table">
								<thead style="border-left: none; border-right: none; display:none;">
									<tr>
								...
								<tbody class="mobile-slide-2"></tbody>
							</table>
						</div>
			  	</div>
			  	...
			  	<div style="width:80%;"><!-- SLICK SLIDE 3 -->
			  		<!-- ROW 1 - SLIDE 3 -->
						...
						<!-- ============ LIST ============ -->
						<div>
							<h3 class="display-5 weight-700 text-center">People</h3>
							<div style="width:50%; height:2px; background-color: #222; margin:0 auto; display:block; margin-top:-10px; margin-bottom:30px;"></div>
							<table class="table the-table">
								<thead style="border-left: none; border-right: none; display:none;">
									<tr>
								...
								<tbody class="mobile-slide-3"></tbody>
							</table>
						</div>
			  	</div>
			</div><!-- //SLICK CONTAINER -->
...
<div class="td-main-content-wrap container dsk-view">
	...
	<div class="container" >
	  <div class="row" style="margin-top:50px; margin-bottom:30px;">
	    <h2 class="display-5 weight-500" style="margin-left:0px;">2018 LEADERBOARD</h2>
	  </div>
	</div>
	...
	<div class="row">
		<!-- SORT BUTTONS -->
		<div class="col-lg-3 col-md-3 col-sm-12 offset-lg-2 offset-md-2">
...
$(document).ready(function(){
	...
	// CHANGE FONT SIZE FOR EACH SLIDE AND FETCH DATA
	$('.mobile-leaderboard-results').on('beforeChange', function(event, slick, currentSlide, nextSlide){
		if(nextSlide == 0) {
			...
			// ORIGINAL JAVASCRIPT CALL - FETCH DATA
			$('#table > tbody').html("");
...
<script type="text/javascript">
	...
	$('.speciesHeader').click( function(){
		console.log(".speciesHeader fired");
		$('.the-table > tbody').html("");
		processSpec(deferredObjs);
	...
	$('.peopleHeader').click( function(){
		console.log(".peopleHeader fired");
		$('.the-table > tbody').html("");
		processPeople(deferredObjs);
		statUpdate('ppl');
		$('.stat-icon').attr("src",stat_icons[2]); 
