<?php
/*  
 *   Template Name: City-List-2021-Django
 */
get_header();
...
<div class="container">
  <div class="row" style="margin-top:100px; margin-bottom:30px;">
    <h2 class="weight-400" style="padding-left:0px;">2021 City List</h2>
    <p>The COVID-19 pandemic is causing cities to adapt to ever-changing circumstances. While this list is updated regularly, it may not reflect any 
	last minute changes to a city’s participation. Please click on the link to your city for any changes to events in your area.</p> 
	<p>If your city is not listed here, we welcome you to join our <a href="https://www.inaturalist.org/projects/city-nature-challenge-2021-global-project">global project</a> and take part wherever you live. Note: To participate in the global 
	project you must first ‘join’ the project, using the link near the top right corner. For all other cities listed below, there is no need to join 
	your local project, though you may choose to do so. All observations made within the boundaries of participating cities between April 30 - May 3 
	will automatically be added.</p> 
	<p>We urge all participants to carefully follow public health guidelines provided by your local governments, as they are changing in real-time. 
Individual safety and public health are our utmost priority.”
</p>
  </div>
</div>
