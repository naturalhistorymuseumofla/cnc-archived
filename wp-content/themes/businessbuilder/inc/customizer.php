...
if(! function_exists('businessbuilder_final_user_customizer_output' ) ):
function businessbuilder_final_user_customizer_output(){
...
<?php }
add_action( 'wp_head', 'businessbuilder_final_user_customizer_output' );
endif;
